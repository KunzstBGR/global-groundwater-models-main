...
MODEL_TYPE_ls = ['full_interpol']#['full','dyn'] # 'full_interpol'
...
for MODEL_TYPE in MODEL_TYPE_ls: 
    ...
    for i in seeds:
        ...
        # Logger
        tb_logger = TensorBoardLogger(save_dir=f'../models/nhits/nhits_{MODEL_TYPE}_teo',
                                      name=f'nhits_{MODEL_TYPE}_{BATCH_SIZE}_{VERSION}_teo')
        ...
        early_stop_callback = EarlyStopping(monitor="val_RMSE", min_delta=1e-4, patience=5, verbose=False, mode="min")
